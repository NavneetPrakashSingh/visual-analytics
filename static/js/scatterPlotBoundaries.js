function d3ScatterPlotWithBoundaries(dataset,datasetBarChart){
  ...
  var svg = d3.select("#scatterPlotWithBoundary")
    .append("svg")
    ...
    .append("g")
      ...
      //boundary for developed nations
      svg
      .append("rect")
        .attr("x",0)
        .attr("y",0)
      ...
      //boundary for developing nations
      svg
      .append("rect")
        .attr("x",0)
        .attr("y",355)
